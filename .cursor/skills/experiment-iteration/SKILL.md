...
When the user wants to iterate on an experiment, read `<folder>/README.md` and use it as context along with any initial thinking they provide.
...
5. When the user is satisfied, update `README.md` in place with the filled sections
